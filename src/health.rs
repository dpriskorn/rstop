...
mod tests {
    ...
    #[test]
    fn test_health_factors_70_mem() {
        let factors = HealthFactors::calculate(75.0, 5.0, 1.0, 2.0, 4);
        assert_eq!(factors.mem_penalty, 15);
    }

    #[test]
    fn test_health_factors_high_load() {
        let factors = HealthFactors::calculate(50.0, 5.0, 5.0, 2.0, 4);
